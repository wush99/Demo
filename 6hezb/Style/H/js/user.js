...
function checkEmail(email){
	...
	if (email == ''){
		...
		$.get("index.html-user.htm"/*tpa=http://www.6hezb.com/themes/default/js/index.html?user*/, { q: "action/check_email", email: email},function (result){
			if ( result == true ){
...
function checkUsername(username){
	var submit_disabled = false;
        //useranme=encodeURIComponent(username);
	...
	if (username == ""){
		...
		$.get("index.html-user.htm"/*tpa=http://www.6hezb.com/themes/default/js/index.html?user*/, { q: "action/check_username", username: username},function (result){
                    //alert(result);
                    if ( result == true ){
...
function checkphone( phone ){
	var submit_disabled = false;
    if ( phone.length != 11  ){
        document.getElementById('phone_notice').innerHTML = phone_msg_shorter;
        pwdFlag=false;
		submit_disabled = true;
    }
    else{
		$.get("index.html-user.htm"/*tpa=http://www.6hezb.com/themes/default/js/index.html?user*/, { q: "action/check_phone", phone: phone},function (result){
			if ( result == true ){
...
function userReg(){
    ...
    if (checkEmail($("#email").val())  && checkUsername($("#username").val()) && checkphone($("#phone").val()) && checkPassword($("#password").val())&&checkConformPassword($("#conform_password").val())  && checkRealname($("#realname").val())){
		$("#submit").display='display';
		return true;
	}
...
var msg_can_reg = "<img src=/Style/M/images/login.gif> <font color=green> 可以注册</font>";
var username_msg = '<img src=/Style/M/images/login2.gif> <font color=red> 请输入4-15位字符.英文,数字</font>';
var username_msg_exist = "<img src=/Style/M/images/login2.gif> <font color=red> 用户名已经存在,请重新输入</font>";
var email_msg_empty = "<img src=/Style/M/images/login2.gif> <font color=red> Email 为空</font>";
var email_msg_invalid = "<img src=/Style/M/images/login2.gif> <font color=red> Email 不是合法的地址</font>";
var email_msg_blank = "<img src=/Style/M/images/login2.gif> <font color=red>邮件地址不能为空</font>";
var email_msg_exist = "<img src=/Style/M/images/login2.gif> <font color=red> 邮箱已存在,请重新输入</font>";
var email_msg_format = "<img src=/Style/M/images/login2.gif> <font color=red> 邮件地址不合法</font>";
var password_msg_shorter = "<img src=/Style/M/images/login2.gif> <font color=red> 登录密码不能少于 6 个字符。</font>";
var phone_msg_shorter = "<img src=/Style/M/images/login2.gif> <font color=red> 手机号码必须是11位数字。</font>";
var phone_msg_exist = "<img src=/Style/M/images/login2.gif> <font color=red> 手机已存在,请重新输入</font>";//waco
var password_msg_confirm_invalid = "<img src=/Style/M/images/login2.gif> <font color=red> 两次输入密码不一致</font>";
var realname_msg_empty = "<img src=/Style/M/images/login2.gif> <font color=red> 真实姓名不能为空</font>";
var realname_msg_len = "<img src=/Style/M/images/login2.gif> <font color=red> 真实姓名不能少于2个汉字,真实姓名不能多于6个汉字</font>";
var realname_msg_chn = "<img src=/Style/M/images/login2.gif> <font color=red> 真实姓名只能为汉字</font>";
var realname_msg_war = "<img src=/Style/M/images/login2.gif> <font color=red> 你的姓氏是错误的,请填写真实的姓氏</font>"; 
/* 会员修改密码 */
...
var msg_can_rg = "<font color=green>可以注册</font>";
var msg_blank = "不能为空";
