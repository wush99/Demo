...
function Transfer(id){
	...
	$.jBox("get:"+Transfer_invest_url+"/ajax_invest?id="+id+"&num="+num, {title: "立即投标",width:450});
}
function tanchu(id,ziduan){
	
	$.jBox("get:"+Transfer_invest_url+"/ajax_tanchu?id="+id+"&ziduan="+ziduan, {title: "详情",width:450});
}
