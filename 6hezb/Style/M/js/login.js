...
arrBox["dvUser"] = "<img style='margin:2px;' src='"+imgpath+"images/zhuce1.gif'/>&nbsp;请填写用户名、邮箱或手机号";
...
arrWrong["dvUser"] = "<img style='margin:2px;' src='"+imgpath+"images/zhuce2.gif'/>&nbsp;用户名格式填写错误。";
